...
x x . . 
";
            ShouldBeString(Nmbr.Eight0, Expected);
        }
...
. . . . 
";
            ShouldBeString(Nmbr.Eight1, Expected);
        }
...
x x . . 
";
            ShouldBeString(Nmbr.Nine0, Expected);
        }
...
. . . . 
";
            ShouldBeString(Nmbr.Nine1, Expected);
        }
...
x x x . 
";
            ShouldBeString(Nmbr.Nine2, Expected);
        }
...
. . . . 
";
            ShouldBeString(Nmbr.Nine3, Expected);
        }
